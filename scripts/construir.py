#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Descarga la página original (bundle mobile) y la convierte en landing standalone (index.html).

LANDING MOBILE: el producto principal es el PACK SUPREMO MOBILE; los order
bumps son Ultimate Leyenda (gold-pc) y la Multiconsola PC (tarjeta gold-mob,
rebautizada por scripts/mobilizar.py)."""
import re, os, urllib.parse, requests
from bs4 import BeautifulSoup, Comment

URL = 'https://consolaultimate.shop/products/retro-gaming-mobile-ultra-retro-mobile-ps2-mobile'
  ...
  window.cuToggleGold = function(cb, key){
    ...
    if(txt){
      var labels = key === "gold-pc"
        ...
        : ["+ AGREGAR MULTICONSOLA PC",    "✓ MULTICONSOLA PC AGREGADA"];
