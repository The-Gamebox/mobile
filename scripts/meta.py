...
# -*- coding: utf-8 -*-
"""
Meta Pixel + atribucion de anuncios (LANDING MOBILE).

Igual que en la landing PC, pero: ViewContent es el PACK SUPREMO MOBILE
(9.99) y el client_reference_id lleva el prefijo "MB-" para que el script
de entrega sepa que "principal" = pack mobile y "gold-mob" = multiconsola PC.
...
(function(){
  ...
  fbq('track', 'ViewContent', {
    content_name: 'PACK SUPREMO MOBILE',
    content_type: 'product',
    content_ids: ['pack-supremo-mobile'],
    value: 9.99,
    currency: 'USD'
  });
})();
